		...
		<section id="section-login">
			<div id="container-login">
				<div id="box-reg">
					...
					<a href="/require/register/register.php"><button class="btn btn-default btn-register">S'inscrire</button></a>
				</div>
				...
				<div id="form-login">
					...
					<form id="form-connect" method="post">
						...
						<br>
						<p>
							<a href="/require/login/login_backoffice.php">En tant qu'administrateur, je me connecte au backoffice.</a>
						</p>
						<br>
