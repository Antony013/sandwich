<?php
	...
	if (isset($_POST["modifier-texte"])) {
		...
		header("Location: require/backoffice.php");
	}
...
?>
	<?php require"require/header_backoffice.php" ?>
	...
	<section id="section-backoffice">	
		...
		<div id="container-backoffice">
			<div id="left-backoffice">
				<p id="first-txt-backoffice">C’est le bon moment pour commander votre sandwiche préféré</p>
				<h1>La sandwicherie<br>du coin</h1>
				<br>
				<p id="last-txt-backoffice"><?php echo $rowSelect['texte_accueil']; ?></p>
				<!-- btn modal pour modifier -->
				<button type="button" id="btn-modif" data-bs-toggle="modal" data-bs-target="#modal-modif">Modifier</button>
			...
			<div id="right-backoffice">
				<form role="form" method="post" name="form-modifier-pdf">
					...
					<input type="file" name="lien_pdf" accept=".pdf">
       				<br><br>
					<input type="submit" name="modifier-pdf" value="Modifier" class="btn btn-primary">
				</form>
			</div>
		</div>
	</section>
