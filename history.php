<?php
	...
	if (isset($_POST["submit_filter"])){
		...
		#si il n'y a pas de filtre enregistré alors "désactiver" le bouton
		...
		<div class="row">
			...
			<div id="nav" class="col-md-3 col-sm-4 col-5">
				<div class="row">
					...
					<div id="log_out">
						<a class="btn btn-default" href="require/logout.php"><span class="bi-box-arrow-left"></span><p>Déconnexion</p></a>
					</div>
				</div>
			</div>
